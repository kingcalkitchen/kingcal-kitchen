...
const LocationsScreen = props => {
  ...
  const markers = [
    {
      ...
      params: {
        title: 'KingCal Kitchen',
        phone: '(317) 876-5432',
        address: {
          street1: '1315 S Rangeline Rd',
          city: 'Carmel',
          state: 'IN',
          zip: '46032',
        },
    ...
    },
    {
      ...
      params: {
        title: 'Cutting Edge Nutrition',
        phone: '(317) 585-0605',
        address: {
          street1: '8282 Center Run Dr',
          city: 'Indianapolis',
          state: 'IN',
          zip: '46250',
        },
  ...
  const renderMarkers = markers.map((marker, idx) => {
    return <Marker key={idx} coordinate={marker.coordinate} onPress={() => navigation.navigate(navigationConstants.LOCATION_DETAIL, marker.params)} />
  })
...
const connectedApp = connect(mapStateToProps)(LocationsScreen)
export { connectedApp as LocationsScreen }
